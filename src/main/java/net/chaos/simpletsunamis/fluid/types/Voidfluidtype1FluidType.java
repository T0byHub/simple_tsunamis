...
public class Voidfluidtype1FluidType extends FluidType {
	public Voidfluidtype1FluidType() {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("simple_tsunamis:block/void_fluid_still");
		...
		}, SimpleTsunamisModFluidTypes.VOIDFLUIDTYPE_1_TYPE.get());
	}
}
